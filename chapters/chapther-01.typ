...
+ Para cada sistema do Exercício 2 que for linear, detemine se é consistente.
  ...
  #solution([
    ...
    No que segue, consideremos a seguinte notação:
    - $L_1$: Representa a linha 1;
    - $L_2$: Representa a linha 2;
    - $L_1 arrow.l.r L_2$: As linhas 1 e 2 trocam de lugar;
    - $L_m arrow a L_m + b L_n$: A linha $m$ é substituída por $a$ vezes a linha $m$ somado a $b$ vezes a linha $n$, em que $a$ e $b$ são constantes e $m, n in {1, 2}$. 
  ])